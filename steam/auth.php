...
<body>
  ...
  <div class="wrapper">
        <div class="header">
            ...
            <div class="button">
                <a href="signup.php" type="text"> Register </a>
            </div>
        </div>
        <div class="clear"></div>
        <form method="POST" action="function.php">
            ...
            <div class="radio-check">
                <input type="radio" class="radio-no" date-id="no" name="remember" value="no" checked>
                <label for="no"><i class="fa fa-times"></i></label>
                <input type="radio" class="radio-yes" date-id="yes" name="remember" value="yes">
